...
namespace PortfolioService
{
    public class JobServer
    {
        ...
        private string endPointName = "HealthMonitor";
        public JobServer()
        {
            ...
            serviceHost = new ServiceHost(typeof(HealthServiceProvider));
            NetTcpBinding binding = new NetTcpBinding();
            serviceHost.AddServiceEndpoint(typeof(IPortfolioService), binding, endpoint);
        }
        public void Open()
        {
            try
